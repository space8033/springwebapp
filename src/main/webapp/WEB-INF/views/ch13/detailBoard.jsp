	...
	<div class="card-body">
		<div>
			<div>
						...
						<p>
							...
							<span>
								...
								<c:if test="${board.battachdata != null}">
									...
									1) 서버의 정적을 요청해서 응답 받는 경우 (ex)photo1.jpg
									2) 요청 경로를 이용해서 컨트롤러에서 응답 받는 경우 (ex)filedownload2?bno=${board.bno}
									만약 데이터를 직접 넣어야 하는 경우
				...
				<c:if test="${board.mid == ch13Login.mid}">
